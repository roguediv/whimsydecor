    ...
    <section className={`ShowProjects ${className}`}>
      ...
      <div className="sct-content">
        ...
        <div className="sct-header center">
          ...
          <Link href="/projects"><button className="orange">View All</button></Link>
        </div>
        {featuredProject ? <>
          <div className="two-grid">
            <Link className="featuredHover" href={`/projects/${featuredProject.projectID}`}>
              <div className="image">
                <Image 
            ...
            <div className="p-2">
              <Link className="featuredHover" href={`/projects/${featuredProject.projectID}`}>
                ...
                <h4>{featuredProject.title.replace("/nl", "")}</h4>
